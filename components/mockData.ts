export interface Property {
  ...
  photosCount: number;
  description: string;
  bhkLabel?: string; // Custom display e.g. "1 & 2" overrides bhk number in titles
  bathrooms?: number;
  balconies?: number;
...
export const seedProperties: Property[] = [
  ...
  */
  ...
  // === ONGOING PROJECTS (UNDER CONSTRUCTION) ===
  {
    ...
    title: "The fRow - Vogue Villas & Sanctioned NA Plots in Paud",
    ...
    photosCount: 2,
    description: "The fRow features premium fashion-inspired Vogue residential NA plots developed by Rising Spaces in Paud, Pune. It offers top-notch modern lifestyle amenities, eco-friendly planning, concrete roads, under-ground lines, and gated community features.",
    facing: "East",
  ...
  },
  {
    ...
    photosCount: 2,
    description: "Codename Tathastu offers high-demand, masterfully planned residential NA plots in Ghotawade near Hinjawadi IT park. Gated plotting township spread across a massive landscape with premium specifications, perfect for building your dream home.",
    facing: "West",
  ...
  },
  {
    ...
    title: "The Pawna Villas - Waterfront Luxury Villas in Pawna",
    ...
    photosCount: 2,
    description: "The Pawna Villas offers stunning 5 BHK luxury villas situated on the gorgeous waterfront of Pawna Lake near Lonavala, perfectly curated for an exclusive lakeside lifestyle with private swimming pools, lush gardens, and breathtaking views.",
    facing: "North-East",
  ...
  {
    id: "ongoing_prakriti",
    title: "Codename Prakriti - Elite Residential NA Plots in Kanhe Phata",
    ...
    photosCount: 2,
    description: "Codename Prakriti offers premium residential NA plots situated at Kanhe Phata along the highway, providing homebuyers and investors an excellent opportunity to build their dream home in a well-connected and serene location.",
    facing: "East",
    amenities: ["Residential Zone", "Concrete Roads", "High Visibility", "Water Supply", "Street Lights"],
  ...
  {
    id: "ongoing_pratham",
    title: "Codename Pratham - Compact 1 & 2 BHK Residential Properties in Varale",
    ...
    photosCount: 2,
    description: "Codename Pratham offers smart-sized 1 & 2 BHK residential properties in Varale near Pune, perfectly designed for first-time homebuyers and investors seeking affordable, well-connected homes in a rapidly growing location.",
    facing: "North",
    amenities: ["Residential Zone", "Wide Access Roads", "Electricity Lines", "Water Supply", "Street Lights"],
  ...
  },
  {
    ...
    photosCount: 2,
    description: "Crown Estate is a highly anticipated premium residential NA plotting layout in Khadkale near Lonavala, featuring superior highway connectivity and a serene environment ideal for weekend homes and villa construction.",
    facing: "West",
    amenities: ["Gated Community", "Gated Compound", "Wide Roads", "Electricity Supply", "CCTV Security"],
  ...
  },
  {
    ...
    photosCount: 2,
    description: "Red Stone is a premium-designed residential NA plotting landmark located in the fast-growing belt of Takve, Kanhe Phata, offering scenic plots perfect for building villas or weekend homes with excellent highway connectivity.",
    facing: "South",
    amenities: ["Gated Community", "Highway Frontage", "Grand Entrance Gate", "Wide Concrete Roads", "Water Points"],
  ...
  },
  {
    ...
    photosCount: 2,
    description: "Eco Town is a residential NA plotting development with sustainable architecture in Ghotawade near Hinjawadi, incorporating eco-friendly infrastructure and green open spaces ideal for nature-loving homeowners.",
    facing: "North-East",
  ...
  // === UPCOMING PROJECTS (COMING SOON) ===
  {
    ...
    photosCount: 2,
    description: "Aangan 18 is a highly-anticipated, upcoming premium townhouse project in Maan, Pune. Spanning over pristine landscape near the Hinjawadi IT Hub, it features thoughtfully designed modern townhouses under a secure gated network with top-class amenities.",
    facing: "East",
    amenities: ["Gated Community", "Concrete Roads", "Underground Electricity", "Water Supply", "Street Lights", "CCTV Security"],
