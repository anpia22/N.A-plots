                ...
                <div className="h-[230px] flex flex-col">
                    ...
                    <div className="bg-[#E0F7FA] px-4 pt-4 pb-3 flex items-center justify-between shrink-0">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-[#0099cc] text-[10px] font-bold uppercase tracking-wider mb-0.5">Preferred Agent</p>
        ...
        <section className="w-full bg-white py-10">
            <div className="max-w-[1200px] mx-auto px-4">
                ...
                <div className="flex items-center justify-between mb-1">
                    <h2 className="text-[#1a1a1a] text-xl font-semibold">Preferred Agents in Pune</h2>
